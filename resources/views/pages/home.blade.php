                        ...
                        <div class="row g-3 mb-0 align-items-center">
                          <div class="col-sm-auto">
                            <div class="input-group">
                              <input
                                type="text"
                                class="form-control border dash-filter-picker"
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  >
                                    <img
                                      src="{{ asset('assets/images')}}/products/img-4.png"
                                      alt=""
                                      class="img-fluid d-block"
                                    />
                                  </div>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0 me-2">
                                    <img
                                      src="{{ asset('assets/images')}}/companies/img-1.png"
                                      alt=""
                                      class="avatar-sm p-2"
                                    />
                                  </div>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0 me-2">
                                    <img
                                      src="{{ asset('assets/images')}}/companies/img-2.png"
                                      alt=""
                                      class="avatar-sm p-2"
                                    />
                                  </div>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0 me-2">
                                    <img
                                      src="{{ asset('assets/images')}}/companies/img-3.png"
                                      alt=""
                                      class="avatar-sm p-2"
                                    />
                                  </div>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0 me-2">
                                    <img
                                      src="{{ asset('assets/images')}}/companies/img-8.png"
                                      alt=""
                                      class="avatar-sm p-2"
                                    />
                                  </div>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0 me-2">
                                    <img
                                      src="{{ asset('assets/images')}}/companies/img-5.png"
                                      alt=""
                                      class="avatar-sm p-2"
                                    />
                                  </div>
                      ...
                      <div class="acitivity-item py-3 d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          ...
                          >
                            ...
                            >
                              <img
                                src="{{ asset('assets/images')}}/products/img-8.png"
                                alt=""
                                class="img-fluid d-block"
                              />
                            </a>
                            ...
                            >
                              <img
                                src="{{ asset('assets/images')}}/products/img-10.png"
                                alt=""
                                class="img-fluid d-block"
                              />
                            </a>
